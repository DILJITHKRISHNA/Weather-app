...
function Sidebar() {
    return (
        <>
            <div className='absolute backdrop-blur-sm bg-gray-700/50 top-2 left-5 h-[90%] mt-8 w-[6%] rounded-2xl hidden md:block'>  {/* Hide on mobile, show on medium and larger */}
